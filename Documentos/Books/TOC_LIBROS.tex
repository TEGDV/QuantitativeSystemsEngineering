...
\usepackage{xcolor}
\definecolor{teal}{rgb}{0.0, 0.35, 0.35}
\usepackage{hyperref}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item 1.1 Dos ecuaciones lineales con dos incógnitas [pp. 20 - 25]
        \item 1.2 $m$ ecuaciones con $n$ incógnitas: eliminación de Gauss-Jordan y gaussiana [pp. 26 - 47]
        \item 1.3 Introducción a MATLAB [pp. 48 - 55]
        \item 1.4 Sistemas homogéneos de ecuaciones [pp. 56 - 62]
    \end{itemize}

    \item \textbf{Capítulo 2: Vectores y Matrices [pp. 63 - 192]}
    \begin{itemize}
        \item 2.1 Definiciones generales [pp. 64 - 79]
        \item 2.2 Productos vectorial y matricial [pp. 80 - 111]
        \item 2.3 Matrices y sistemas de ecuaciones lineales [pp. 112 - 119]
        \item 2.4 Inversa de una matriz cuadrada [pp. 120 - 144]
        \item 2.5 Transpuesta de una matriz [pp. 145 - 151]
        \item 2.6 Matrices elementales y matrices inversas [pp. 152 - 163]
        \item 2.7 Factorizaciones LU de una matriz [pp. 164 - 181]
        \item 2.8 Teoría de gráficas: una aplicación de matrices [pp. 182 - 192]
    \end{itemize}

    \item \textbf{Capítulo 3: Determinantes [pp. 193 - 248]}
    \begin{itemize}
        \item 3.1 Definiciones [pp. 194 - 209]
        \item 3.2 Propiedades de los determinantes [pp. 210 - 226]
        \item 3.3 Determinantes e inversas [pp. 227 - 236]
        \item 3.4 Regla de Cramer [pp. 237 - 241]
        \item 3.5 Demostración de tres teoremas importantes y algo de historia [pp. 242 - 248]
    \end{itemize}

    \item \textbf{Capítulo 4: Vectores en $\mathbb{R}^2$ y $\mathbb{R}^3$ [pp. 249 - 312]}
    \begin{itemize}
        \item 4.1 Vectores en el plano [pp. 250 - 264]
        \item 4.2 El producto escalar y las proyecciones en $\mathbb{R}^2$ [pp. 265 - 273]
        \item 4.3 Vectores en el espacio [pp. 274 - 283]
        \item 4.4 El producto cruz de dos vectores [pp. 284 - 294]
        \item 4.5 Rectas y planos en el espacio [pp. 295 - 312]
    \end{itemize}

    \item \textbf{Capítulo 5: Espacios Vectoriales [pp. 313 - 434]}
    \begin{itemize}
        \item 5.1 Definición y propiedades básicas [pp. 314 - 325]
        \item 5.2 Subespacios vectoriales [pp. 326 - 332]
        \item 5.3 Combinación lineal y espacio generado [pp. 333 - 348]
        \item 5.4 Independencia lineal de vectores [pp. 349 - 366]
        \item 5.5 Bases y dimensión de espacios vectoriales [pp. 367 - 379]
        \item 5.6 Cambio de bases [pp. 380 - 401]
        \item 5.7 Rango, nulidad, espacio de renglones y columnas de una matriz [pp. 402 - 426]
        \item 5.8 Fundamentos de la teoría de espacios vectoriales: existencia de una base (opcional) [pp. 427 - 434]
    \end{itemize}

    \item \textbf{Capítulo 6: Espacios Vectoriales con Producto Interno [pp. 435 - 496]}
    \begin{itemize}
        \item 6.1 Bases ortonormales y proyecciones en $\mathbb{R}^n$ (Gram-Schmidt) [pp. 436 - 460]
        \item 6.2 Aproximaciones por mínimos cuadrados [pp. 461 - 481]
        \item 6.3 Espacios con producto interno y proyecciones [pp. 482 - 496]
    \end{itemize}

    \item \textbf{Capítulo 7: Transformaciones Lineales [pp. 497 - 562]}
    \begin{itemize}
        \item 7.1 Definición y ejemplos de transformaciones lineales [pp. 498 - 510]
        \item 7.2 Propiedades: Imagen, núcleo, rango y nulidad [pp. 511 - 518]
        \item 7.3 Representación matricial de una transformación lineal [pp. 519 - 543]
        \item 7.4 Isomorfismos entre espacios vectoriales [pp. 544 - 551]
        \item 7.5 Isometrías y transformaciones ortogonales [pp. 552 - 562]
    \end{itemize}

    \item \textbf{Capítulo 8: Valores Característicos, Vectores Característicos y Formas Canónicas [pp. 563 - 664]}
    \begin{itemize}
        \item 8.1 Valores y vectores característicos (Autovalores y Autovectores) [pp. 564 - 579]
        \item 8.2 Un modelo de crecimiento de población [pp. 580 - 585]
        \item 8.3 Matrices semejantes y diagonalización [pp. 586 - 601]
        \item 8.4 Matrices simétricas y diagonalización ortogonal [pp. 602 - 612]
        \item 8.5 Formas cuadráticas y clasificación de secciones cónicas [pp. 613 - 626]
        \item 8.6 La forma canónica de Jordan [pp. 627 - 641]
        \item Aplicación: forma matricial de ecuaciones diferenciales [pp. 642 - 652]
